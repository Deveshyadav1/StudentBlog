...
<nav class="navbar navbar-expand-lg  blur border-radius-xl top-0 z-index-fixed shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
  <div class="container-fluid px-0">
    <a class="navbar-brand font-weight-bolder ms-sm-3" href="#" rel="tooltip" title="" data-placement="bottom" target="">
      {{Auth::user()->name}}
    </a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-7 text-center mx-auto">
          <h1 class="text-white pt-3 mt-n5">Student Blog</h1>
          <p class="lead text-white mt-3">Empowering Minds, Inspiring Voices: Your Platform to Share and Connect Through Thoughtful Blogging.</p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-md-4 position-relative">
            <div class="p-3 text-center">
              ...
              <h5 class="mt-3">Total Blogs</h5>
              <p class="text-sm font-weight-normal">Dive into a world of diverse perspectives with our myriad blogs—each a unique tapestry of thoughts, experiences, and ideas waiting to captivate and inspire</p>
            </div>
          ...
          <div class="col-md-4 position-relative">
            <div class="p-3 text-center">
              ...
              <p class="text-sm font-weight-normal">Meet the Brilliant Minds Behind the Words: Our Authors, A Diverse Collective of Thought Leaders, Storytellers, and Experts</p>
            </div>
            <hr class="vertical dark">
          </div>
          <div class="col-md-4">
          ...
          <div class="card card-rotate card-background card-background-mask-primary shadow-primary mt-md-0 mt-5">
            <div class="front front-background" style="background-image: url(https://images.unsplash.com/photo-1569683795645-b62e50fbf103?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80); background-size: cover;">
              <div class="card-body py-7 text-center">
                ...
                <h3 class="text-white">Feel the <br /> Student Blog</h3>
            ...
            <div class="back back-background" style="background-image: url(https://images.unsplash.com/photo-1498889444388-e67ea62c464b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1365&q=80); background-size: cover;">
              <div class="card-body pt-7 text-center">
                ...
                <a href="#"  class="btn btn-white btn-sm w-50 mx-auto mt-3">Start with Your first blog</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container py-7 postion-relative z-index-2 position-relative">
      <div class="row">
        <div class="col-md-7 mx-auto text-center">
          ...
          <h3 class="text-white">Student Blog</h3>
          <p class="text-white mb-5"></p>
          <a href="#" class="btn btn-primary btn-lg mb-3 mb-sm-0">Student Blog App</a>
        </div>
      </div>
    </div>
  </div>
